...
***************** points
****************** fronts;locations;
** Swinging Gait                                                  :log:notes:
  [2022-06-10 Fri 09:28]
*** Hacker News
    https://news.ycombinator.com/item?id=31690765
**** Swinging Gait
     involuntary swinging of the arms forward and backward while walking.
       * Synchronously when in both arms.

** Republic of Lebanon                                                :notes:
   لبنان
   [2022-06-10 Fri 15:20]
** Crayola                                                        :notes:log:
  [2022-07-23 Sat 12:51]
*** message
   Subject: harmonies
  ...
  Color Scales
     ~*~ palettes ~*~
       depth ~ reflections ~ signs
          * elements
*** Other
   [[https://shop.crayola.com/on/demandware.store/Sites-Crayola-Site/default/CAContactUs][Contact Crayola]]
* log
** Common Knowledge
