...
****** Peace
**** dots
***** the Sentate, the House
****** Structure
******* Privelages, Accountabilities, Legislations
******** Structurals
********* dimensions ~ visions ~ changes
********** steps
********* strokes
********** increments ~ changes ~ visions
*********** spectrums ~ acts
******* Majorty, Consensus
******** Majorities
********* specturums
...
********* acts
********** divisions
*********** interests;ideologies;specturms;
************ divisions
************* comimitees;quorums;motions;
******** Consensus
******* Members
******** gate
********* Eagle Fountain
